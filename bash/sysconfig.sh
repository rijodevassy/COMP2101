...
function error-message {
     echo "Displaying the Help options to user.\n " >&2

}

# This function will send a message to stderr and exit with a failure status
# Usage:
#   error-exit [" text to print to stderr in case of failure" [exit-status]]
function error-exit {
displayhelp
	echo "Script ends here " >&2
	exit 1
}
